...
<body>
    ...
    <div style="margin-top: 100px; text-align: center; font-family: 'Poppins', sans-serif;">
        ...
        ?>
        <p>This is your Admin Dashboard. Here you'll see your calendar and tasks.</p>
        <p><a href="logout.php">Logout</a></p> 
    </div>

    <footer>
        <a href="#"><img src="Resources/calendar" alt=""></a>
        <a href="#"><img src="Resources/classwork" alt=""></a>
        <a href="#"><img src="Resources/myNotes" alt=""></a>
    </footer>
</body>
</html>